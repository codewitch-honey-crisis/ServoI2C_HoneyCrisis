...
void setup() {
  ...
  xTaskCreate(led_task,"led_task",4000,nullptr,5,&task_handle); 
}
...
void led_task(void* state) {
  // Global variables from the LED INO go here
  // Code from inside setup() in the LED INO
  // don't include Serial.begin()
  while(true) {
    // Code from inside loop() in the LED INO goes here
    // or otherwise call your functions
